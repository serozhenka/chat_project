...
urlpatterns = [
    ...
    path('friend_list/<str:user_id>/', views.friend_list, name='friend-list'),
    ...
    path('friend_request/<str:receiver_id>/cancel/', views.cancel_friend_request, name='friend-request-cancel'),
]